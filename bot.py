# (c) @Dragobotz
# This file is a part of https://github.com/Dragobotz/BotStatus
...
async def BotzHub():
    async with user_bot:
        while True:
            ...
            await user_bot.edit_message(int(chnl_id), msg_id, "**@DragoXServer Bots Stats.**\n\n`Performing a periodic check...`")
            c = 0
            edit_text = "**@DragoXServer Bots Stats.**\n\n"
            for bot in bots:
